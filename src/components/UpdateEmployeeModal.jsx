...
import { updateEmployee } from '../store/actions/clientActions'; // استورد الأكشن ديالك للتحديث

export const UpdateEmployeeModal = ({ employee, onClose }) => {
  const dispatch = useDispatch();

  // نعمر الفورم ببيانات الموظف اللي جا من props
  ...
  useEffect(() => {
    if (employee) {
      setFormData({
        ...
        hireDate: employee.hireDate ? employee.hireDate.slice(0, 10) : '', // لتنسيق التاريخ yyyy-mm-dd
      });
    }
  }, [employee]);
